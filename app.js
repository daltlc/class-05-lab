...
function multiply(a,b) {
	var product = a*b;
	var text2 = 'The product of 4 and 7 is 28.'
	var array2 = [product,text2];
	return array2;
}
...
function sumAndMultiply(a,b,c){
	var sum = a + b + c;
	var product1 = a * b;
	var productFinal = product1*c;
	var third = "4 and 7 and 5 sum to 16."
	var forth = "The product of 4 and 7 and 5 is 140."
	var sAndM = [sum,productFinal,third,forth];
	return sAndM;
}
...
function multiplyArray (numArray) {
	function prodcut(a,b) {
    return a*b;
	}
	var numArray = [2,3,4].reduce(prodcut);
	var text = 'The numbers 2,3,4 have a product of 24.';
	var problem5 = [numArray,text];
	return problem5;
}
